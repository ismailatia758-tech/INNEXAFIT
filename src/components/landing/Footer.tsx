      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-20">
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center text-3xl font-extrabold tracking-tight mb-6">
            ...
            <p className="text-muted-foreground max-w-sm mb-8">
              The operating system for elite fitness coaches. Empowering coaches to scale 
              their business through AI and automation.
            </p>
            <div className="flex space-x-4">
              {[Facebook, Instagram, Whatsapp].map((Icon, i) => (
                <button key={i} className="p-2 rounded-xl bg-secondary text-muted-foreground hover:text-foreground transition-all">
                  <Icon size={20} />
                </button>
              ))}
            </div>
        ...
        <div className="pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
          <p>© 2026 INNEXA FIT. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
